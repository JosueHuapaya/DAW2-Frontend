...
export class CrudPrestatarioAgregarComponent {
  @Output() prestatarioAgregado = new EventEmitter<void>();
  ...
  registra() {
    ...
    this.prestatarioService.registrarPrestatarioCrud(this.prestatario).subscribe(
      x => {
        Swal.fire({ icon: 'info', title: 'Resultado del Registro', text: x.mensaje, });
        this.prestatarioAgregado.emit();
        this.prestatario = {
          nombres: '',
          apellidos: '',
          dni: '',
