...
export class CrudEntidadFinancieraAgregarComponent {
  ...
  constructor(private entidadFinancieraService: EntidadFinancieraService,
    ...
    registra(){
      ...
      this.entidadFinancieraService.registrarCrudEntidad(this.entidadFinanciera).subscribe(
        x => {
